...
- Receiving photo inputs use the device's standard image chooser so mobile users can select existing library photos or open the camera; they do not force camera-only capture.
