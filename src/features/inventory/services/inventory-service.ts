  ...
  return {
    ...
    saveReceiptDraft(input: SaveReceiptDraftInput) {
      return transact((snapshot, now) => {
        ...
        const documentEvidence = addEvidence(snapshot, now, operatorName, { file: input.documentFile, photoType: "Document", caption: "Receiving document" }, { siteId: input.siteId, projectId: input.projectId, lotId: null, receiptId, movementId: null, outboundBatchId: null, issueId: null, locationId: input.stagingLocationId })
